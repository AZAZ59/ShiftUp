...
class GetGroups extends React.Component {
    method_name = 'Collector.Users.get_groups';
    default_state = {
        user_ids: '',
        limit: 2
    };
        ...
        return (
            <div class='content'>
                <div className="page-header">
                    <h1>Сбор людей, на которых подписаны пользователи</h1>
                </div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    >
                        ...
                        />
                        <ControlLabel>У какого кол-ва людей пользователь должен быть в подписках:</ControlLabel>
                        <FormControl
                            type="number"
